...
class BankCategoryController extends BaseCategoryController {
    ...
    */
    ...
    protected function redirectBackAction(){
        return Redirect::action('BankCategoryController@index');
    }


    protected function viewOfActionIndex(){
        return 'admin.system.bank.index';
    }
    protected function viewOfActionCreate(){
        return 'admin.system.bank.create';
    }
    protected function viewOfActionShow(){
        return 'admin.system.bank.detail';
    }
    protected function viewOfActionEdit(){
        return 'admin.system.bank.edit';
    }
