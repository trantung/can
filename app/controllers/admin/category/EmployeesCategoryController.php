...
class EmployeesCategoryController extends BaseCategoryController {
    ...
    */
    ...
    protected function redirectBackAction(){
        return Redirect::action('EmployeesCategoryController@index');
    }


    protected function viewOfActionIndex(){
        return 'admin.system.employees.index';
    }
    protected function viewOfActionCreate(){
        return 'admin.system.employees.create';
    }
    protected function viewOfActionShow(){
        return 'admin.system.employees.detail';
    }
    protected function viewOfActionEdit(){
        return 'admin.system.employees.edit';
    }
