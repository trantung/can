...
class DepartmentCategoryController extends BaseCategoryController {
    ...
    */
    ...
    protected function redirectBackAction(){
        return Redirect::action('DepartmentCategoryController@index');
    }
