...
class IndustryCategoryController extends BaseCategoryController {
    ...
    */
    ...
    protected function redirectBackAction(){
        return Redirect::action('IndustryCategoryController@index');
    }


    protected function viewOfActionIndex(){
        return 'admin.system.industry.index';
    }
    protected function viewOfActionCreate(){
        return 'admin.system.industry.create';
    }
    protected function viewOfActionShow(){
        return 'admin.system.industry.detail';
    }
    protected function viewOfActionEdit(){
        return 'admin.system.industry.edit';
    }
