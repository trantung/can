...
class CurrencyCategoryController extends BaseCategoryController {
    ...
    */
    ...
    protected function redirectBackAction(){
        return Redirect::action('CurrencyCategoryController@index');
    }


    protected function viewOfActionIndex(){
        return 'admin.system.currency.index';
    }
    protected function viewOfActionCreate(){
        return 'admin.system.currency.create';
    }
    protected function viewOfActionShow(){
        return 'admin.system.currency.detail';
    }
    protected function viewOfActionEdit(){
        return 'admin.system.currency.edit';
    }
