...
class EthnicCategoryController extends BaseCategoryController {
    ...
    */
    ...
    protected function redirectBackAction(){
        return Redirect::action('EthnicCategoryController@index');
    }


    protected function viewOfActionIndex(){
        return 'admin.system.ethnic.index';
    }
    protected function viewOfActionCreate(){
        return 'admin.system.ethnic.create';
    }
    protected function viewOfActionShow(){
        return 'admin.system.ethnic.detail';
    }
    protected function viewOfActionEdit(){
        return 'admin.system.ethnic.edit';
    }
