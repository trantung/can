...
class CertificateCategoryController extends BaseCategoryController {
    ...
    */
    ...
    protected function redirectBackAction(){
        return Redirect::action('CertificateCategoryController@index');
    }


    protected function viewOfActionIndex(){
        return 'admin.system.certificate.index';
    }
    protected function viewOfActionCreate(){
        return 'admin.system.certificate.create';
    }
    protected function viewOfActionShow(){
        return 'admin.system.certificate.detail';
    }
    protected function viewOfActionEdit(){
        return 'admin.system.certificate.edit';
    }
