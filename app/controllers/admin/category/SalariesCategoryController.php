...
class SalariesCategoryController extends BaseCategoryController {
    ...
    */
    ...
    protected function redirectBackAction(){
        return Redirect::action('SalariesCategoryController@index');
    }


    protected function viewOfActionIndex(){
        return 'admin.system.salaries-category.index';
    }
    protected function viewOfActionCreate(){
        return 'admin.system.salaries-category.create';
    }
    protected function viewOfActionShow(){
        return 'admin.system.salaries-category.detail';
    }
    protected function viewOfActionEdit(){
        return 'admin.system.salaries-category.edit';
    }
