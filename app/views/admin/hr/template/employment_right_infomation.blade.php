 <!-- left column -->
    <div class="col-md-6 col-sm-6 col-xs-12">
        ...
        <div class="form-group form-group-sm row">
        <div class="col-xs-12">
            <input class="form-control input-sm" type="text" name="date_of_issue" placeholder="Ngày cấp"  id="datepickerEnddate" >
        </div>
        </div>
        {{-- date_of_issue --}}
        <div class="form-group form-group-sm row">
        ...
        <div class="form-group form-group-sm row">
        <div class="col-xs-12">
            {{ Form::select('nationality_category_id', $nationality_category_id, null, array('class'=>'form-control input-sm')) }}
        </div>
        </div>
        {{-- Nationnality --}}
        <div class="form-group form-group-sm row">
          <div class="col-xs-12">
            {{ Form::select('sex', getSex(), null, array('class'=>'form-control input-sm')) }}
        ...
        <div class="form-group form-group-sm row">
        <div class="col-xs-12">
        {{ Form::select('ethnic_group_id', $ethnic_group_id, null, array('class'=>'form-control input-sm')) }}
        </div>
        </div>
        {{-- Ethnic Group --}}
        <div class="form-group form-group-sm row">
        <div class="col-xs-12">
            {{ Form::select('religion_category_id', $religion_category_id, null, array('class'=>'form-control input-sm')) }}
        </div>
        </div>
        {{-- religion --}}
        <div class="form-group form-group-sm row">
          <div class="col-xs-12">
             {{ Form::select('contract_category_id', $contract_category_id, null, array('class'=>'form-control input-sm')) }}
          </div>
        </div>
        {{-- contract_category --}}
    ...
    <div class="col-md-6 col-sm-6 col-xs-12 personal-info">
        ...
        <div class="form-group form-group-sm row">
           <div class="col-xs-12">
            {{ Form::select('employees_category_id', $employees_category_id, null, array('class'=>'form-control input-sm')) }}
          </div>
        </div>
        {{-- personal_category --}}
