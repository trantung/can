...
<div class="row margin-bottom">
  <div class="col-xs-12">
    <a href="{{ action('PositionCategoryController@index') }}" class="btn btn-success">Danh sách vị trí</a>
  </div>
</div>
        ...
        {{ Form::open(array('action' => 'PositionCategoryController@store')) }}
          <div class="box-body">
            <div class="form-group">
              <label for="username">Tên vị trí</label>
              <div class="row">
                <div class="col-sm-6">
                    <input type="text" class="form-control" id="name" placeholder="Tên vị trí" name="name" value="{{Input::old('name')}}">
                </div>
              </div>
            </div>
            <div class="form-group">
