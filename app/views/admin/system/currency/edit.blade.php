...
<div class="row margin-bottom">
    <div class="col-xs-12">
        ...
        <a href="{{ action('CurrencyCategoryController@create') }}" class="btn btn-primary">Thêm loại tiền</a>
    </div>
</div>
@endif
...
<div class="row">
    <div class="col-xs-12">
        <div class="box box-primary">
            <!-- form start -->
            {{ Form::open(array('action' => array('CurrencyCategoryController@update', $data->id), 'method' => 'PUT')) }}
               <div class="box-body">
