...
<div class="row">
    <div class="col-xs-12">
        ...
        <!-- form start -->
        {{ Form::open(array('action' => 'ReligionCategoryController@store')) }}
          <div class="box-body">
            <div class="form-group">
              <label for="username">Tên Tôn giáo</label>
              <div class="row">
                <div class="col-sm-6">
                    <input type="text" class="form-control" id="name" placeholder="Tên Tôn giáo" name="name" value="{{Input::old('name')}}">
                </div>
              </div>
            </div>
            <div class="form-group">
